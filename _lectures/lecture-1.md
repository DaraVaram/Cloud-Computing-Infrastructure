...
![Cloud Computing: The 5th utility!]({{ '/figures/Cloud Computing (5th Utility).png' | relative_url }})
...
| -------- | -------- | --------- |
|Public Cloud|The cloud infrastructure is provisioned for open use by the general public. It may be owned, managed, and operated by a business, academic, or government organization, or some combination of them. It exists on the premises of the cloud provider. <ul><li>Basically, anyone can access this cloud.</li> <li>IaaS, PaaS, SaaS through Azure, Google, AWS, etc...</li></ul>|![Public Cloud]({{ '/figures/Public Cloud.png' | relative_url }})|
|Private Cloud|The cloud infrastructure is provisioned for **exclusive use** by a single organization comprising multiple consumers (for example, business units). It may be owned, managed, and operated by the **organization**, a **third party**, or **some combination** of them, and it may exist on or off premises. <ul><li>For a specific organization</li> <li> On premise: There's a physical resource that exists on the premises, fully managed by the organization itself </li>   <li>Provides complete control over the infrastructure and the data, enables standardization of IT sources, processes, and services (for that specific organization) </li></ul>|![Private Cloud]({{ '/figures/Private Cloud.png' | relative_url }})|
||Externally Hosted Private Cloud: <ul><li>The cloud implementation itself is outsourced to an external provider </li> <li> The cloud is hosted on the **provider's** premises, not the organization. </li>   <li>Consumers connect to it over a secure network. Access policies isolate the cloud resources from other tenants (from an organization level). </li></ul>|![External Private Cloud]({{ '/figures/External Private Cloud.png' | relative_url }})|
